...
- feat: add advanced automation policies and rule intelligence ([#32](https://github.com/domschmidt/ha-household-tasks/pull/32))

## 4.13.1 - 2026-08-04

### Fixed

- fix: caldav ([#31](https://github.com/domschmidt/ha-household-tasks/pull/31))

## 4.13.0 - 2026-08-03

### Added

- feat(caldav): add secure bidirectional task sync ([#30](https://github.com/domschmidt/ha-household-tasks/pull/30))

## 4.12.0 - 2026-08-03

### Added

- feat(tasks): add automatic routine credit ([#29](https://github.com/domschmidt/ha-household-tasks/pull/29))

## 4.11.0 - 2026-08-03

### Added

- feat(tasks): add temporary template pauses ([#28](https://github.com/domschmidt/ha-household-tasks/pull/28))

## 4.10.1 - 2026-08-02

### Fixed

- fix(ui): keep daily context on today view ([#27](https://github.com/domschmidt/ha-household-tasks/pull/27))

## 4.10.0 - 2026-08-02

### Added

- feat(ui): streamline daily work and live updates ([#26](https://github.com/domschmidt/ha-household-tasks/pull/26))
